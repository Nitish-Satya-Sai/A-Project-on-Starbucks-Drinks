...
im = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\Starbucks-AI-earnings-call_4.jpg") 
im2=Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\good.png")
...
star_bucks = pd.read_csv(r"https://raw.githubusercontent.com/Nitish-Satya-Sai/data-is-crucial/main/cleaned_star_bucks.csv")
...
with st.sidebar:
    ...
    optionm = option_menu("Main menu", ["👉 🤩🤩🤩 Make yourself ready to enjoy the enchanting storylines of your favorite drink.🤩🤩🤩",
     "👉 Feel free to play with the Data to discover more insights 😀🤔😁😱😎","Exploratory Data Analysis","Dataset description"], default_index=0)
...
if optionm=="👉 🤩🤩🤩 Make yourself ready to enjoy the enchanting storylines of your favorite drink.🤩🤩🤩":
    ...
    im3=Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\correlation.png")
    st.image(im3)
    ...
    st.write("#### Few research studies shows that caffeine interferes with the absorption of vitamin C😱😶‍🌫️😥 , It means that we might not be getting the full benefits of your healthy diet if you regularly drink coffee, tea or other caffeinated beverages alongside meals?")
    ...
    st.write("### Overall, The Starbucks brand portrays some good nutritional values, but in reality 🤔, they are overweighed by Bad dietary values.")
    out=Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\outweights.png")
    st.image(out)
    st.write("[Image Source](https://mwtb.org/pages/bad-or-good)")
    ...
    st.write('''
             ...
             ''')
# =============================================================================
#     figp = px.parallel_coordinates(star_bucks, 
#                               dimensions=['Calories',
#        'Total Fat (g)', 'Trans Fat (g)', 'Saturated Fat (g)', 'Sodium (mg)',
#        'Total Carbohydrates (g)', 'Cholesterol (mg)', 'Dietary Fibre (g)',
#        'Sugars (g)', 'Protein (g)', 'Vitamin A (% DV)', 'Vitamin C (% DV)',
...
#                               color_continuous_midpoint=2,width=950, height=500)
...
# =============================================================================
    ...
    with col3:
     ...
     ["strip","scatter","distribution","histogram","combinational plots","trends"],index=4)
    ...
    with col6:
        imj1 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j1.png")
        st.image(imj1)
    with col7:
        imj2 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j2.png")
        st.image(imj2)
    col8,col9 = st.columns(2,gap="medium")
    with col8:
        imj1 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j3.png")
        st.image(imj1)
    with col9:
        imj2 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j4.png")
        st.image(imj2)
    col10,col11 = st.columns(2,gap="medium")
    with col10:
        imj1 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j5.png")
        st.image(imj1)
    with col11:
        imj2 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j6.png")
        st.image(imj2)
    col12,col13 = st.columns(2,gap="medium")
    with col12:
        imj1 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j7.png")
        st.image(imj1)
    with col13:
        imj2 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j8.png")
        st.image(imj2)
    col14,col15 = st.columns(2,gap="medium")
    with col14:
        imj1 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j9.png")
        st.image(imj1)
    with col15:
        imj2 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j10.png")
        st.image(imj2)
    col16,col17 = st.columns(2,gap="medium")
    with col16:
        imj1 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j11.png")
        st.image(imj1)
    with col17:
        imj2 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j12.png")
        st.image(imj2)
    col18,col19 = st.columns(2,gap="medium")
    with col18:
        imj1 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j13.png")
        st.image(imj1)
    with col19:
        imj2 = Image.open("D:\Michigan_State_University_Works\CMSE-830\Homeworks\Heroku\j14.png")
        st.image(imj2)
